    ...
    public class Mage : Piece
    {
        ...
        public override List<Move> GetMoves(Gamestate state)
        {
            ...
            if (layer == Layer.Upper)
            {
                ...
                if (!Move.IsBlocked(state, current_square, dir, 0, 0, 2, this.color))
                {
                    ...
                    Move.moveAttempt(state, moves, current_square, dir, 0, 0, 1, capture);
                }
            }
            else if (layer == Layer.Lower)
            {
                ...
                if (!Move.IsBlocked(state, current_square, dir, 0, 0, 2, this.color))
                {
                    ...
                    Move.moveAttempt(state, moves, current_square, dir, 0, 0, 3, capture);
                }
            }
            // Level 2 moves
            else
